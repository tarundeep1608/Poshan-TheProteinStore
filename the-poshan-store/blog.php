...
<html xmlns="http://www.w3.org/1999/html">
    <head>
        ...
        <style>
            ...
            #more {display: none; color: #171515}
            #mor {display: none; color: #171515}
        </style>
    </head>
    <body onload="loadfun()">
    <div id="loading"></div>
    ...
    <ol class="breadcrumb" style="color: black">
        ...
        <li class="breadcrumb-item active" aria-current="page">Poshan Blog</li>
    </ol>
        ...
        <div id="content">
            ...
            <main>
                ...
                <header id="blog-header">
                    <h1 style="text-align: center; font-family: Montserrat,sans-serif;padding-left: 220px">EATING RIGHT</h1>
                </header>
                ...
                <article id="blog-content">
                    ...
                    <div id="blog-image-container">
                        <div id="views">
                            <img src="https://drive.google.com/uc?export=view&id=19o5NgWJVq7fTE1f_-Oo_s-IWP46Z-4DG" alt="views">
                            <span><b>Views:</b></span>
                            <span><b>1,137</b></span>
                        </div>
                        <img src="https://drive.google.com/uc?export=view&id=10wYnUkda7DZnzKSFJkb31LxbbPojhIhC" alt="Step-by-step walk" />
                    </div>

                    <p>
                    <h1 style="font-size: 23px; font-family: 'Roboto Thin'">Iced Golden Latte</h1>
                    <hr>
                    Enjoy this delicious Golden Latte recipe in the comfort of your home using Poshan Daily Protein Haldi Badaam.Turmeric, the nutrition powerhouse in our protein makes it a power packed drink and it only takes a couple of minutes to make. It is high in antioxidants, improves joint pain, helps with memory and brain function, and improves mood. It is a great swap for caffeine and is a modern take on an ancient healing drink.
                    </p>

                    <img src="https://drive.google.com/uc?export=view&id=1pI0CUVrUed4E0EGgA5AaFztR5AX3Xauw" alt="Code screenshot from laptop" />

                    <p>
                     <h1 style="font-size: 23px; font-family: Serif">THE INDIAN PROTEIN GAP</h1>
                    <hr>
                    ...
                    Protein is one of the most critical components in our daily diets. Why is it critical? Very simply the body can't really 'store' protein. Excess protein consumption gets converted to fat but there isn't any way excess fat can get converted to protein. So if your body does not get its fill of this critical building block, you can’t 'make it up' the next day or the day after. And this is what we call the protein gap.


                    </p>
                    <img src="https://drive.google.com/uc?export=view&id=1q8tsWTXe0vV0JI31u5G-lMfujz8AiWuD" alt="Code screenshot from laptop" />
                    <p>
                    <h1 style="font-size: 23px; font-family: 'Roboto Thin'">Good Food Made Easy With Poshan</h1>
                    <hr>
                    Poshan - Good Made Easy!  At its core, poshan is all about nutrition and good food. So we blended whey made from the antibiotic free, hormone free milk of grass-fed cows with natural curcumin-rich turmeric and pure antioxidant laden green tea. We are as obsessed with what we keep out of our food as we are with what we add into them. So, our blends contain no soy, no GMO, no antibiotics, no preservatives, no trans-fat, strictly no nasties!...
                    <br><a href="" style="color: black;text-decoration: none">Read more ></a>
                    </p>
                    <p>
                    <img src="https://drive.google.com/uc?export=view&id=1Y2Nq30Zzk0Epx3WnHYd21V8Gh9HxZrwi" alt="photo4"/>
                    <h1 style="font-size: 23px; font-family: 'Roboto Thin'">ARE YOU GETTING ENOUGH PROTIEN</h1><hr>
                    ...
                    If 24 gm of protein, 30 grams of scoop size and 5.765 gm of BCAA mean nothing to you, then you are not alone. This is gibberish to most people. So we thought we should try and simplify (much to the dislike of the old school) the eternal question of “how much protein”?
                        ...
                        <img src="https://drive.google.com/uc?export=view&id=1nKn6J51mQ7kX4ncimr3d6juinlaKqfJu" alt="photo5"/>
                    <h1 style="font-size: 23px; font-family: 'Roboto Thin'">WHAT THE WHEY?</h1><hr>
                    <p>Look anywhere online and you will be undoubtable bombarded with the myriad health benefits, tips, tricks & myths surrounding Whey Protein. This blog post is a definitive guide to help you gain clarity on one of the most effective & scientifically...
                        <br><a href="" style="color: black;text-decoration: none">Read more ></a>
            ...
            <aside>
                <section id="subscription" class="widget">
                    <h4 class="widget-title">Subscribe now to lead a healthy life!</h4>
                    <hr>
...
<hr>
                ...
                <section id="recent-posts" class="widget">
                    ...
                    <ul>
                        <li>
                            <p><a href="">Guide to a healthy life</a></p>
                        </li>
                        <li>
                            <p><a href="">Detox Diet</a></p>

                        </li>
                        <li>
                            <p><a href="">The best time to start your journey with POSHAN</a></p>

                        </li>
                        <li>
                            <p><a href="">How to take care of your diet amidst Covid</a></p>

                        </li>
                        <li>
                            <p><a href="">What the whey!</a></p>
                ...
                <section id="recent-comments" class="widget">
                    ...
                    <ul>
                        <li>
                            <p>
                                <a class="name" href="">Me and my journey with poshan</a>
                                <span>on</span>
                                <a href="">Poshan's journey with me</a>
                            </p>
                        </li>
                        <li>
                            <p>
                        ...
                        <li>
                            <p>
                                ...
                                <span>on</span>
                                <a href="">The good, the bad and the not so ugly</a>
                            </p>
                        </li>
                        <li>
                            <p>
...
<hr>
            ...
            <div id="social">
                <a id="facebook" class="social-btn" href="#"><img class="social-img" src="https://ninjasfiles.s3.amazonaws.com/asset_0000000000000014_1549330414_facebook-logo.png" alt="fb"></a>

                <a id="linkedin" class="social-btn" href="#"><img class="social-img" src="https://ninjasfiles.s3.amazonaws.com/asset_0000000000000015_1549330433_linkedin-logo.png" alt="in"></a>

                <a id="twitter" class="social-btn"  href="#"><img class="social-img" src="https://ninjasfiles.s3.amazonaws.com/asset_0000000000000016_1549330452_twitter-logo.png" alt="twi"></a>

                <a id="gmail" class="social-btn"  href="#"><img class="social-img" src="https://ninjasfiles.s3.amazonaws.com/asset_0000000000000017_1549330467_google-logo.png" alt="g+"></a>

                <a id="whatsapp" class="social-btn" href="#"><img class="social-img" src="https://ninjasfiles.s3.amazonaws.com/asset_0000000000000018_1549330485_whatsapp-logo.png" alt="w-app"></a>

                <a id="mail" class="social-btn"  href="#"><img class="social-img" src="https://ninjasfiles.s3.amazonaws.com/asset_0000000000000019_1549330510_mail-logo.png" alt="mail"></a>
            </div>
