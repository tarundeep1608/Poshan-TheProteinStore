<?php
    ...
    if (isset($_POST['register'])) {
        ...
        if ($query->rowCount() == 0) {
           ...
           echo 'alert("Your Registration was successful.");';
      ...
      <div class="form">
        <div class="login">
          <div class="login-header">
              <br>
            <h3>NEW USER</h3>
            <p>Please enter your credentials to register as new user.</p>
          </div>
        </div>
        <form class="login-form" method="POST" action="registration.php" name="signup-form">
            <p style="text-align: left;">Enter Name :</p>
          <input type="text" placeholder="*Name" name="username" required/>
          <p style="text-align: left;">Enter Email Id :</p>
          <input type="email" placeholder="*abc@gmail.com" name="email" required/>
          <p style="text-align: left;">Enter Phone No. :</p>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
        ...
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
        <script src="login-js.js" charset="utf-8"></script>
      </div>
    </div>
<!--footer-->
<div class="footer">
